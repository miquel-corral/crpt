...
admin.site.register(crptapp.models.YesNoValues)
admin.site.register(crptapp.models.LowMidHighValues)
admin.site.register(crptapp.models.EffectivenessValues)
admin.site.register(crptapp.models.MaxValues)
admin.site.register(crptapp.models.MeetingFrequencyValues)
admin.site.register(crptapp.models.MeetingAttendanceValues)
